...
interface NetInfoDisInternetReachableState<T extends NetInfoStateType> {
  type: T;
...
export type NetInfoUnknownState = NetInfoDisInternetReachableState<
  NetInfoStateType.unknown
>;
export type NetInfoNoConnectionState = NetInfoDisInternetReachableState<
