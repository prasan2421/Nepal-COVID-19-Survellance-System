            ...
            return(
                <View style={{marginBottom:20,elevation:2,position:'relative',width:'95%',flexDirection: 'row',alignItems:'center',justifyContent:'center',backgroundColor:'#eae98f',padding:10,borderRadius:5}}>
                    ...
                    <View style={{paddingVertical:4,paddingHorizontal:15,borderRadius:5}}>
                        <Text style={{color:'#333333',fontSize:14}}><Text style={{fontWeight:'bold'}}>Note </Text>: If you have travelled abroad in the last 14 days then specific care along with consultation with specialist must be taken.</Text>
                    </View>
                </View>
            )
        }
                            ...
                            >
                                <View style={{alignItems:'center'}}>
                                    <View style={{padding:15,}}>
                                        <Text style={{color:'#fff'}}>Return to Dashboard</Text>
                                    </View>
                    ...
                    <ScrollView
                        ...
                        <View>
                            ...
                            <View style={{width:'100%',marginTop:10,alignItems: 'center'}}>
                                <View style={{elevation:2,position:'relative',width:'95%',flexDirection: 'row',alignItems:'center',justifyContent:'center',backgroundColor:'#fff',padding:20,borderRadius:5}}>
                                    <View>
                                        <Text style={{color:'#f9156c',fontSize:18,textAlign:'center',marginBottom:20}}>Your health status has been successfully updated.</Text>
