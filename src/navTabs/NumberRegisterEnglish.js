...
class New extends React.Component<{}, State> {
    ...
    next = async() =>  {
        ...
        if(number.length<10){
            number_Error = 'Length of phone no. is no enough';
        }
...
// this.hideLoader();
                                this.props.navigation.navigate('RegisterEnglish',{
                                    number:number,
                                ...
                                Alert.alert('Success','Mobile no is registered. You will receive four digit PIN in SMS.')
