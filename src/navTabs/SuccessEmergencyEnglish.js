            ...
            <ScrollView
                ...
                <View style={{width:'100%',marginBottom:10,marginTop:10,alignItems: 'center'}}>
                    <View style={{elevation:1,position:'relative',width:'95%',flexDirection: 'row',alignItems:'center',justifyContent:'center',backgroundColor:'#fff',padding:20,borderRadius:5}}>
                        <View>
                        <Text style={{color:'#f9156c',fontSize:18,textAlign:'center',marginBottom:20}}>Your message is successfully posted.</Text>
                            <Text style={{color:'#575757',fontSize:14}}>Please take care of your health and update your health status three times a day (around 9 AM, 2 PM and 10 PM).</Text>
