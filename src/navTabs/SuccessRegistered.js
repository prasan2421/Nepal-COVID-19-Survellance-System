            ...
            <ScrollView
                ...
                <View style={{width:'100%',marginBottom:10,marginTop:10,alignItems: 'center'}}>
                    <View style={{elevation:1,position:'relative',width:'95%',flexDirection: 'row',alignItems:'center',justifyContent:'center',backgroundColor:'#fff',padding:20,borderRadius:5}}>
                        ...
                        <View>
                        <Text style={{color:'#f9156c',fontSize:18,textAlign:'center',marginBottom:20}}>तपाईको दर्ता सफल भयो |</Text>
                            <Text style={{color:'#575757',fontSize:14,marginBottom:10}}>
                                दर्ता भएको मोबाइल न. : <Text style={{fontWeight:'bold'}}>{this.state.number}</Text>
                              </Text>
                            <Text style={{color:'#575757',fontSize:14,marginBottom:10}}>
                                पिन न. : <Text style={{fontWeight:'bold'}}>{this.state.name}</Text>
                              </Text>
